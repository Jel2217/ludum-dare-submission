...
export var waves = 3
export var blue_slime_amount = 3
export var green_slime_amount = 1
export var purple_slime_amount = 0
export var red_slime_amount = 1
export var yellow_slime_amount = 1
